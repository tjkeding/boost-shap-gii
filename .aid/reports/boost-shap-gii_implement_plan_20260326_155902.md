...
<implement_plan>
 ...
 <changes>
 <change id="change-1" priority="P0" source_item="the listed item: Conda environment upgrade">
 ...
 <change id="change-2" priority="P0" source_item="the listed item: Validate pip install -e.">
 ...
 <change id="change-3" priority="P1" source_item="the listed item: Update README.md">
 ...
 <dependencies> (verify CLI works before documenting it)</dependencies>
 <risk>low - documentation-only change</risk>
 <rollback>git checkout README.md</rollback>
 </change>

 <change id="change-4" priority="P1" source_item="the listed item: Update INPUT_SPECIFICATION.md">
 ...
 <dependencies> (verify package structure before documenting it)</dependencies>
 <risk>low - documentation-only change</risk>
