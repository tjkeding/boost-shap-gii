...
<implement_plan>
 ...
 <!-- ===== P1 ===== -->
 <change id="change-2" priority="P1" source_item=" ">
 ...
 <change id="change-3" priority="P1" source_item=" ">
 <file path="train.py" action="modify" />
 <file path="predict.py" action="modify" />
 ...
 <change id="change-4" priority="P1" source_item=" ">
 <file path="train.py" action="modify" />
 ...
 <change id="change-5" priority="P1" source_item=" ">
 <file path="predict.py" action="modify" />
 ...
 raise AssertionError(f"Found {len(model_files)} model file(s) in {run_dir} but CV splitter "
 f"expects {expected_folds} fold(s). Re-run train.py or check output_dir."
)
 </spec>
 <dependencies> (predict.py must be syntactically valid first)</dependencies>
 <risk>low - additive guard, will only raise if there is a genuine mismatch</risk>
 <rollback>Remove the assertion block</rollback>
 </change>

 <change id="change-6" priority="P1" source_item=" ">
 ...
 <!-- ===== P2 ===== -->
 <change id="change-9" priority="P2" source_item=" ">
 ...
 <change id="change-10" priority="P2" source_item=" ">
 <file path="utils.py" action="modify" />
 ...
 <change id="change-11" priority="P2" source_item=" ">
 ...
 <change id="change-12" priority="P2" source_item=" ">
 <file path="utils.py" action="modify" />
...
...
 ...
 if drop_rate > 0.05:
 print(f"[WARNING] compute_bootstrap_ci: {drop_rate:.1%} of bootstrap iterations "
 ...
 print(f"[WARNING] compute_permutation_test: reached {max_attempts} attempt cap. "
 ...
 <dependencies> (both are plot.R changes; can be applied in sequence)</dependencies>
 ...
 <!-- Note: and both modify plot.R; apply sequentially. moved last among utils.py changes for clarity. -->
</implement_plan>
