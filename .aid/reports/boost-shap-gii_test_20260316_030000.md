...
<test_report>
 ...
 <error_type>AssertionError</error_type>
 <message>Stale test: changed calculate_v_spline_2d to route to stacked-spline/group-means instead of returning 0.0. Test expected 0.0, got 0.452.</message>
 ...
 <error_type>AssertionError</error_type>
 <message>Stale tests: changed one_hot_max_size to fixed [2, 25] range. Tests assumed p-dependent scaling.</message>
 ...
 <files_created>
 <file path="tests/test_implementation_changes.py" test_count="54" coverage_target="All 15 implementation changes from brainstorm/implement cycle" />
 </files_created>
 <files_modified>
 ...
 to validate each change individually plus cross-change integration tests. Test classes
 cover: syntax correctness, function signature changes, ordinal validation tiers,
 shadow model early stopping, model-count assertion, stacked-spline routing,
 NaN handling, p-value correction, search space bounds, dependency checks,
 bootstrap tracking, plot.R changes, and permutation test loop.
 </design_rationale>
 </design_phase>
 <post_design_run>
 <total>337</total>
