<brainstorm_report>
 ...
 <file path="train.py" relevance="Shadow model iteration count, inner CV seed, ordinal validation" />
 <file path="predict.py" relevance="Syntax error, model count validation" />
 <file path="shap_utils.py" relevance="Statistical findings findings 14-25" />
 <file path="utils.py" relevance="Config defaults, bootstrap CI, check_env" />
 <file path="plot.R" relevance="Core cap" />
 </context_files>

 <!-- =================================================================
 SESSION 1 BRAINSTORM: CR FINDINGS TRIAGE
 Status: INCOMPLETE — reviewed findings 1-10, stopped at finding 10 pending user input.
 Findings findings 11-25 not yet discussed.
 ================================================================= -->
 ...
 <approach label="Fixed multiplier" feasibility="high" risk="med">
 ...
 <approach label="Leave as-is, document" feasibility="high" risk="med">
 ...
 <decision status="decided" chosen="">Option (a): early stopping with outer validation fold, tuned_iters * 2 ceiling, same early_stopping_rounds patience.</decision>
 </topic>
 ...
 <approaches>
 <approach label="Drop and warn" feasibility="high" risk="low">
 ...
 <approach label="Assign worst-case score" feasibility="med" risk="med">
 ...
 <!-- Finding 11: plot.R N_CORES cap -->
 <!-- Finding 12: Column ordering (note — no action needed) -->
 <!-- Finding 13: Ensemble soft voting calibration (note — document) -->
 <!-- Finding 14: Interaction SHAP 2x scale -->
 <!-- Finding 15: 2D spline zero-return fallback -->
 <!-- Finding 16: NaN-to-zero bootstrap bias -->
 <!-- Finding 17: Boruta adaptive noise baseline -->
 <!-- Finding 18: Missing +1 correction on exceedance p-values -->
 <!-- Finding 19: 2D energy check heuristic limitation -->
 <!-- Finding 20: Bootstrap method-switching at discrete threshold -->
 <!-- Finding 21: Stability metric for zero-variance estimates -->
 <!-- Finding 22: NaN mask alignment fragility -->
 <!-- Finding 23: Permutation test effective count reporting -->
 <!-- Finding 24: SHAP decomposition non-additivity (note) -->
 <!-- Finding 25: GII insensitivity to constant-effect features (note) -->
 ...
 <item priority="P1" target_mode="implement" description="Finding 3: Add two-tier ordinal unknown check (unique-value + observation-level)" />
 <item priority="P1" target_mode="implement" description="Finding 4: Shadow model early stopping with outer val fold, 2x iteration ceiling" />
 <item priority="P1" target_mode="implement" description="Finding 5: Add model-count vs fold-count assertion in predict.py" />
 <item priority="P1" target_mode="implement" description="Finding 8: Add joblib and statsmodels to check_env.py" />
 <item priority="P2" target_mode="implement" description="Finding 6: Add floor to depth search space" />
 <item priority="P2" target_mode="implement" description="Finding 7: Fix one_hot_max_size to fixed [2, 25] range" />
 <item priority="P2" target_mode="document" description="Finding 9: Document __NA__ sentinel behavior" />
 <item priority="P2" target_mode="implement" description="Finding 10: PENDING — add drop tracking + warning at minimum; worst-case-score TBD" />
 </action_items>

 <next_steps>
 Resume brainstorm at finding 10 (pending user decision on drop-and-warn vs worst-case-score), then continue through findings 11-25. After all findings are triaged, proceed to /implement mode for the decided fixes.
 </next_steps>
</brainstorm_report>
