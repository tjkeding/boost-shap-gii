<implement_plan>
 ...
 <changes>
 <change id="change-1" priority="P0" source_item="the listed items: ordinal CategoricalDtype casting in train.py, predict.py, infer.py">
 ...
 <change id="change-2" priority="P1" source_item="the listed items: nominal.astype('category') in train.py, predict.py, infer.py">
 <file path="src/boost_shap_gii/train.py" action="modify" />
 <file path="src/boost_shap_gii/predict.py" action="modify" />
 <file path="src/boost_shap_gii/infer.py" action="modify" />
 <description>
 ...
 <change id="change-3" priority="P1" source_item="the listed item: shap_utils.py _to_numeric_matrix">
 ...
 category-typed or object-typed. Similar to, bare `.astype('category')` infers categories
 ...
 <change id="change-4" priority="P1" source_item="the listed item: test_adversarial.py test_ordinal_empty_levels_list">
 ...
 <change id="change-5" priority="P1" source_item="the listed item: test_infer.py test_ordinal_unknown_values_become_nan">
 ...
 <notes>
 Change 2 (nominal.astype("category") in train/predict/infer) requires no code change; the bare
