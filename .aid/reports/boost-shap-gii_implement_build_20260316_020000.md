...
<implement_report>
 ...
 <change id="change-5" status="done">
 <files_modified>
 ...
 <change id="change-6" status="done">
 <files_modified>
 ...
 <change id="change-7" status="done">
 <files_modified>
 ...
 <change id="change-8" status="done">
 <files_modified>
 ...
 <change id="change-9" status="done">
 <files_modified>
 ...
 <change id="change-10" status="done">
 <files_modified>
 <file path="utils.py" lines_changed="1" />
 </files_modified>
 ...
 <change id="change-11" status="done">
 <files_modified>
 ...
 <change id="change-12" status="done">
 <files_modified>
 ...
 <change id="change-13" status="done">
 <files_modified>
 ...
 <change id="change-15" status="done">
 <files_modified>
 ...
 <change id="change-14" status="done">
 <files_modified>
 ...
 <next_steps>Recommended: run /test to validate all changes. No existing test suite coverage was verified for the shadow model early-stopping path or the stacked-spline routing in calculate_v_spline_2d — these are the highest-priority candidates for new test cases.</next_steps>
</implement_report>
