<implement_plan>
 ...
 <changes>
 <change id="change-1" priority="P2" source_item="">
 <file path="shap_utils.py" action="modify" />
 <description>Replace two-line stale comment at line 750 that referenced removed NaN-to-zero behavior. The NaN replacement was removed in Session 3; the comment "Compute BEFORE replacing NaN with 0.0." no longer describes any existing behavior.</description>
 ...
 <change id="change-3" priority="P2" source_item="">
 ...
 <change id="change-4" priority="P2" source_item="">
 <file path="shap_utils.py" action="modify" />
